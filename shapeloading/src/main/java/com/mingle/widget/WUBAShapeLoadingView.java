 ...
 */
public class WUBAShapeLoadingView extends View {
    ...
    public WUBAShapeLoadingView(Context context) {
        super(context);
        init();
    }

    public WUBAShapeLoadingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public WUBAShapeLoadingView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
