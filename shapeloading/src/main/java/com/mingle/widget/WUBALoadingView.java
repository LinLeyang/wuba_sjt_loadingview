 ...
 */
public class WUBALoadingView extends FrameLayout {

    private static final int ANIMATION_DURATION = 500;

    private static float mDistance = 200;

    private WUBAShapeLoadingView mShapeLoadingView;
    ...
    public WUBALoadingView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
